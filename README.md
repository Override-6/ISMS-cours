...
**Séances 1 à 8 closes côté dossier, côté outil et côté bureau du RSSI** (16 pages sur 16, F7/F12/F14/F19 clos). La séance 7 est **entièrement faite** : les deux TD, les deux TP, le livrable `D7` (5 pts) et la sous-section 7 de la note — coûts du plan de traitement lus dans `translog-b` (82K €/an, 13/13 mesures), les deux acceptations formelles créées comme objets `Risk acceptances`. **La séance 8 est entièrement faite** : le TD 1, les deux pages individuelles, les deux TP saisis dans `translog-b` (30 exigences de clauses évaluées, 15 contrôles d'annexe A investigués, 16,1 % de couverture), le livrable `D8` (2 pts) et la sous-section 8 de la note. Reste le CM (non noté). **F20, relecture transversale du rendu contre le fil rouge du module (15 septembre), a trouvé trois pièces que la note affirmait sans les prouver** : la charte de gouvernance de `D1` (écrite depuis), le taux de conformité par thème de `D4` (écrit depuis), et la longueur de `D5` (resserrée, sans atteindre la demi-page demandée — le contenu exigé le justifie). **Il manque surtout les supports de soutenance — 30 points, coefficient 3, rien n'existe à ce jour** — et la note de stratégie n'existe pas encore en PDF. Tout ce qui relève de la séance 9 n'est pas « en retard » — elle n'a pas eu lieu.

| Bloc noté | Poids | Acquis aujourd'hui | Reste |
|---|---|---|---|
| **Livrables D1→D9** | 40 pts → /20, **coef. 4** | **34 pts** assemblés (D1 4 · D2 5 · D3 4 · D4 4 · D5 3 · D6 7 · D7 5 · **D8 2**) | D9 = 3 pts, séance non tenue |
| **Note de stratégie** (pièce 1) | 3 pts (inclus dans les 40) | **8 sous-sections sur 9**, toutes rédigées | 1 sous-section, séance 9 |
| **Bureau du RSSI** | 10 pts, **coef. 1**, **individuel** | **16 pages sur 16** pour les huit séances tenues — S1→S8 complètes, les deux auteurs (F7, F12, F14 et F19 clos) | ⏳ les deux pages S9, séance non tenue · 🟡 tenue en longueur à resserrer sur les 16 (voir F19) |
