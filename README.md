...
**Séances tenues : 3 sur 9.** Tout ce qui relève des séances 4 à 9 n'est pas « en retard » — ces séances n'ont pas eu lieu.
...
| **Bureau du RSSI** | 10 pts, **coef. 1**, **individuel** | Miguel : **3 pages sur 3** | Maxime : **3 pages sur 3 à écrire** |
...
| S4 | Audit | D4 | 4 | ⏳ séance non tenue | — |
...
| **4** | **F7 · Les trois pages du bureau du RSSI de Maxime** — S1, S2, S3, **une page chacune**, individuelles, closes par une recommandation à la direction | dossier | **Maxime** | **10 pts, coef. 1** | Grande |
...
**Les trois questions du bureau du RSSI, pour Maxime :**
...
|---|---|---|
| **S4** | **D4** — audit / état des lieux *(sources déjà reçues : `S4 - Sources/`, `Correction/`)* | 4 |
