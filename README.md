...
| **S7** | Traitement du risque · EBIOS RM atelier 4 + registre | **D7** Plan de traitement et risque résiduel | 5 | ✅ **assemblé** — TD 1 + TD 2 + TP 1 + TP 2 ; plan de traitement par décision (13 mesures), sept fiches d'acceptation, zéro dérogation, sous-section 7 rédigée. Les 2 pages S7 du bureau du RSSI sont rendues (F19) | ✅ registre à 8 lignes, résiduels cotés, coûts saisis (82K €/an, 13/13 mesures), 2 `Risk acceptances` créées |
| **S8** | Périmètre du SMSI · business case de certification | **D8** Déclaration d'applicabilité | 2 | 🔄 **TD 1, bureau du RSSI et TP 1 faits** — restent le CM, le TP 2 et `D8` | ✅ clauses 4-10 évaluées (30 exigences), SoA à 15 contrôles, exclusion `A.8.28` justifiée |
...
### 🔴 Avant la remise du 17 septembre — 4 chantiers, par enjeu décroissant
...
| **2** | **Séance 8 · le CM, le TP 2, le livrable `D8` et la sous-section 8** — périmètre du SMSI, contrôles retenus, exclusions justifiées par écrit (la réserve sur E4 en tête), taux de couverture, écarts restants | `Session-8/` + `translog-b` | Miguel · Maxime | **2 pts** + note | Moyenne |

| **3** | **F17 · Les quatre arbitrages ouverts** — les trois mesures datées deux fois (`M1`/`PT-03`, `M2`/`PT-06`, `M4`/`PT-02`), le titre du dirigeant de la filiale, les porteurs des mesures de `D4`, les jalons non datés de `D6` | tout le dossier | Miguel · Maxime | exactitude | Petite |
| **4** | **F19 · Resserrer les seize pages du bureau du RSSI à une page franche** — elles font 574 à 864 mots ; « une page, tenue en longueur » est l'un des trois blocs notés | `Session-*/1-CISO-desk/` | Miguel · Maxime | **3 des 10 pts** individuels | Moyenne |
