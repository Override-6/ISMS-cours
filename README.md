...
| **S6** | Tiers et projets · EBIOS RM ateliers 3-4 | **D6** Tiers et projets | **7** | 🔄 **TD 1 et TD 2 faits** (bureau du RSSI × 2, note collective, ateliers 3-4 par écrit) + **mode opératoire du TP 1 écrit** — restent la saisie des TP 1 et 2 | ⏳ écosystème et scénarios à saisir (ateliers 3-4) |
...
- **Séance 6 — mode opératoire du TP 1 prêt** (`Session-6/2-Labs/PLAN-Seance-6-TP-S6-05-ecosysteme-et-scenarios.md`) : les cinq exercices de l'énoncé traduits en gestes et en critères de validation — reprise de l'étude de la séance 5 (écart des **7** événements redoutés assumé, D5 fait foi), **5 parties prenantes** avec leur description et leurs **20 notes** justifiées, seuil de criticité, **2 scénarios stratégiques** (couples n°1 et n°4) avec leurs chemins d'attaque rédigés, **1 scénario opérationnel** en sept actions élémentaires coté **V3** avec sa justification. Signale aussi une pièce citée par D5 mais absente de `Session-5/3-Evidence/` (capture du rapport d'étude), à produire pendant que l'instance est ouverte.
