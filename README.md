...
| **2** | **Séance 8 · le CM, les deux TP, le livrable `D8` et la sous-section 8** — périmètre du SMSI, contrôles retenus, exclusions justifiées par écrit (la réserve sur E4 en tête), taux de couverture, écarts restants | `Session-8/` + `translog-b` | Miguel · Maxime | **2 pts** + note | Moyenne |
