...
Ce fichier enregistre **ce que la saisie a réellement produit** dans `translog-b`, écart par écart avec ce qui était prévu.
...
Vérifiés à l'écran avant tout clic (capture `S7-05-ex0-etude-compteurs-avant-saisie.jpg`)  — rien n'a été recréé : l'étude ouverte en séance 5 et enrichie en séance 6 sert de support.
...
|---|---|---|---|
| OS1 | `Very likely` | `High` | Oui (vérifié, non ressaisi) |
| OS2 | `Very likely` | `High` | Oui |
| OS3 | `Likely` | `Medium` | Oui |
