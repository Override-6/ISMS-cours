...
**Critère de marquage** : pour toute paire, une seule question — *le livrable cité existe-t-il réellement dans le dossier MERIDIAN, et couvre-t-il au moins une partie de la lettre de l'exigence ?* Les trois paires ci-dessus satisfont ce critère (livrables produits et référencés dans le dossier du groupe).
...
> **Correction du 8 septembre 2026.** Une première version de cette section affirmait que le ReCyF était **introuvable** dans la bibliothèque, et en tirait une leçon sur le millésime de l'outil. **C'est faux, et notre propre capture le prouve** — `../3-Evidence/S3-05-ex4-library-search-ReCyF.jpg`. La correction est conservée ici plutôt que l'erreur effacée : c'est la discipline du dossier.
