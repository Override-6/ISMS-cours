...
> **Correction du 8 septembre 2026.** La note d'outillage du ReCyF était de **2**, justifiée par un « outillage encore incertain ». La capture `S3-05-ex4-library-search-ReCyF.jpg` montre que le référentiel **est présent nativement** dans la bibliothèque de l'instance. La note passe à **3**, le total de 195 à **205**. Le classement ne bascule pas ; les tests de sensibilité ci-dessous sont recalculés en conséquence.
