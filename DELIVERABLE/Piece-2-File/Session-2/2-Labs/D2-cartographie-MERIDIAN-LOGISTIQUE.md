...
|---|---|---|---|---|---|
| `PA-01` Exécution des flux | **TI** | **TI** | Notable | Notable | Un arrêt > 6 h bloque 40 % du volume expédié du groupe |
