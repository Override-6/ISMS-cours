...
- **Argument pour « observation »** *(gradation retenue ci-dessus)* : aucune exigence n'est précisément violée ; on est dans le signal qu'il serait malhonnête de taire, pas dans l'écart mesurable contre un critère.
