...
| **Qui accepte le risque résiduel d'un flux inter-filiales** — la valeur métier est à Santé, les biens supports sont chez Logistique (D2 §5, limite structurelle) | **Direction Générale du groupe** (D5 §1) ; l'accord inter-filiales de M3 le formalise. Une cartographie de groupe supposerait un objet au-dessus des instances de l'outil (D2 §5) — l'accord y supplée. |
