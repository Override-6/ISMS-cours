...
### La présence à observer : le **ReCyF**

> ⚠️ **Correction du 8 septembre 2026.** Une première version de cette section affirmait que le ReCyF était **introuvable** dans la bibliothèque, et en tirait une leçon sur le millésime de l'outil. **C'est faux, et notre propre capture le prouve** — `../3-Evidence/S3-05-ex4-library-search-ReCyF-FOUND-see-note.jpg`. La correction est conservée ici plutôt que l'erreur effacée : c'est la discipline du dossier.

**Ce que l'écran montre réellement** : fournisseur **ANSSI**, identifiant `ReCyF`, nom **« RECYF : RÉFÉRENTIEL CYBER France – Version 2.5 du 17/03/2026 »**, entrée **built-in**, langue **française**, **date de publication 2026-07-09**, « Showing 1 to 1 of 1 ».

**La vraie leçon, et elle est meilleure que la fausse.** La bibliothèque de l'outil suit les publications de l'autorité de plus près que nous ne le supposions : un référentiel diffusé en version de travail en mars y est disponible en juillet. Ce n'est donc pas la disponibilité qui nous fait écarter le ReCyF — **nous l'avons trouvé et nous avons choisi de ne pas l'importer**. Importer tout ce qui est disponible rendrait l'instance illisible et ferait croire à un engagement d'évaluation qui n'existe pas : on importe la colonne vertébrale, on met le reste en veille.

**Conséquence sur la grille du matin (S3-03)** : la note d'outillage du ReCyF passe de 2 à 3, son total pondéré de 195 à **205**, et l'écart avec ISO se resserre de 35 à **25 points sur 300**. Le classement ne bascule pas, et surtout la **règle de veto** — qui écarte le ReCyF sur la couverture d'une filiale hors champ NIS 2, sans regarder la note — n'est pas touchée. La correction est reportée dans le fichier du TD.

*Nuance de méthode conservée* : un éditeur de logiciel **fige un état à chaque version** et l'ANSSI **publie à son propre rythme** — la vérification à l'écran reste donc obligatoire. Nous en avons ici la démonstration par l'inverse : c'est **nous** qui étions périmés, pas l'outil.
...
| **Tri** | Quatre bibliothèques trouvées et triées avec éditeur et justification ; sort du ReCyF établi sur pièce | ✅ Guide d'hygiène / DORA / HDS v2.0 / RGS 2.0 Annexe B2 triés ; **ReCyF trouvé** dans la bibliothèque (ANSSI, v2.5 du 17/03/2026, publié le 09/07/2026) et **volontairement non importé**, correction du 8 sept. 2026 assumée au dossier |
