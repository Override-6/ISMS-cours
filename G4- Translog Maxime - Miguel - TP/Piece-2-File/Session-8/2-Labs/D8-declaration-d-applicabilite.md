...
**Groupe 4 (Translog)** · Miguel Monereo, Maxime · filiale sous revue **MERIDIAN Logistique** · instance `translog-b`, domaine `MERIDIAN-LOGISTIQUE`, périmètre `MERIDIAN-LOGISTIQUE-FINAL`
...
| **A.5.15**, **A.8.8** | ✅ **Corrigé en séance 9** (`fixes.md` F22 §3) : retenus et non conformes ici, avec un traitement nommé (`PT-02`, `PT-01`), **désormais inscrits au tableau mesure ↔ exigence de D7 §6** | Rapprochement justifié ci-dessus, repris tel quel dans D7 §6. Les deux contrôles ne sont plus orphelins ni de fait ni au registre |
...
> traitement de D7. Or trois mesures de D4 portent sur les **mêmes** contrôles avec des dates et parfois des
> porteurs différents — `M1` (VLAN automates, 12/07/2027) contre `PT-03` (14/06/2027, la mesure qui la
> contient et qui referme pourtant avant elle) ; `M2` (avenant intégrateur, 08/12/2026) contre `PT-06`
> (14/03/2027) ; `M4` (registre nominatif TMA, 08/11/2026) contre `PT-02` (14/01/2027). L'écart est décrit
> et **délibérément laissé ouvert** par F17 — une décision d'auteur, pas une correction mécanique. Cette
> déclaration cite `D7` parce que c'est la lecture la plus récente et la plus chiffrée du plan de
> traitement, sans que l'écart de dates avec D4 soit refermé pour autant.
...
*Livrable D8 — 2 points. Matière directe de la **sous-section 8** de la note de stratégie (`../../../Piece-1-Strategy-note/MERIDIAN-strategy-note.md`). Pièces à l'appui : feuille de travail du TP 1 `Seance-8-TP-S8-05-feuille-de-travail-evaluation-et-SoA.md`, mode opératoire `PLAN-Seance-8-TP-S8-05-evaluation-clauses-et-SoA.md`, captures `../3-Evidence/S8-05-*`, note collective du TD 1 `../1-CISO-desk/Seance-8-TD-S8-01-le-business-case-de-la-certification.md`.*
