...
> EBIOS RM pour l'homologation de sécurité d'un système d'information (citée au CM S5 et S1). Le cycle
...
**mineure / significative / grave / critique** (= Minor / Significant / Important / Critical dans
l'outil). Gravité justifiée par la nature des impacts : missions, réglementation/contrat, personnes,
...
| **Ex. 3 — socle** | Table à quatre colonnes couvrant PSSI-cadre, guide d'hygiène, ISO 27001:2022 et obligations contractuelles du client ; écarts repris de l'audit S4 avec leur gradation (C3, C4 majeures ; C7 conforme sur flux à l'arrêt) ; décision « poursuivre en intégrant la non-conformité » en trois phrases, avec sa conséquence sur les ateliers 3 à 5 |
