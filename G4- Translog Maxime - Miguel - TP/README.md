...
- `1-CISO-desk/` — page de **Miguel rendue** ; **celle de Maxime reste à écrire** (note individuelle, angles distincts proposés dans le `README` du dossier). Voir `fixes.md` F7.
...
- `1-CISO-desk/` — page de **Miguel rendue** ; celle de Maxime reste à écrire. Voir `fixes.md` F7.
